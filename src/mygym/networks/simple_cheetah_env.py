...
class SymCheetahEnv(MujocoEnv, utils.EzPickle):
    ...
    base position[x,y,z] base velocity
    left and right joints positions and veloctities
    """
    ...
    def _get_obs(self):
        ...
        base_linear_acceleration = self.data.qacc  # [x_ddot, z_ddot, y_ddot]

        print("position",position)
        print("velocity",velocity)
        print("base_linear_acceleration",base_linear_acceleration)
